...
const WordCloudBackground: React.FC = () => {
  ...
  useEffect(() => {
    if (canvasRef.current) {
      ...
      WordCloud(canvas, {
        list: words,
        gridSize: Math.round(2 * scaleFactor), // ✅ Smaller grid size ensures higher density
        weightFactor: (size) => (size / 4.0) * scaleFactor, // ✅ Ensures words fill the screen
        fontFamily: "Arial",
        ...
        drawOutOfBound: false, // ✅ Prevents words from being cut off
